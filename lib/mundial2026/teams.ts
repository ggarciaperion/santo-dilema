...
export const TEAMS: Record<string, Team> = {
  ...
  PAR: { id: 'PAR', name: 'Paraguay',  shortName: 'Paraguay',  code: 'PAR', flag: '\u{1F1F5}\u{1F1FE}', confederation: 'CONMEBOL', eloRating: 1650, fifaRanking: 65, apiFootballId: 30  },
  ...
  HAI: { id: 'HAI', name: 'Haití',           shortName: 'Haití',     code: 'HAI', flag: '\u{1F1ED}\u{1F1F9}', confederation: 'CONCACAF', eloRating: 1480, fifaRanking: 92, apiFootballId: 98  },
  CUW: { id: 'CUW', name: 'Curazao',         shortName: 'Curazao',   code: 'CUW', flag: '\u{1F1E8}\u{1F1FC}', confederation: 'CONCACAF', eloRating: 1510, fifaRanking: 100, apiFootballId: 1862 },
  ...
  SWE: { id: 'SWE', name: 'Suecia',          shortName: 'Suecia',     code: 'SWE', flag: '\u{1F1F8}\u{1F1EA}', confederation: 'UEFA', eloRating: 1790, fifaRanking: 24, apiFootballId: 8  },
  NOR: { id: 'NOR', name: 'Noruega',         shortName: 'Noruega',    code: 'NOR', flag: '\u{1F1F3}\u{1F1F4}', confederation: 'UEFA', eloRating: 1740, fifaRanking: 28, apiFootballId: 118 },
  CZE: { id: 'CZE', name: 'Chequia',         shortName: 'Chequia',    code: 'CZE', flag: '\u{1F1E8}\u{1F1FF}', confederation: 'UEFA', eloRating: 1700, fifaRanking: 40, apiFootballId: 31 },
  BIH: { id: 'BIH', name: 'Bosnia-Herz.',    shortName: 'Bosnia',     code: 'BIH', flag: '\u{1F1E7}\u{1F1E6}', confederation: 'UEFA', eloRating: 1640, fifaRanking: 60, apiFootballId: 18 },
  ...
  CPV: { id: 'CPV', name: 'Cabo Verde',      shortName: 'Cabo Verde',  code: 'CPV', flag: '\u{1F1E8}\u{1F1FB}', confederation: 'CAF', eloRating: 1560, fifaRanking: 88, apiFootballId: 5145 },
  COD: { id: 'COD', name: 'RD Congo',        shortName: 'RD Congo',    code: 'COD', flag: '\u{1F1E8}\u{1F1E9}', confederation: 'CAF', eloRating: 1540, fifaRanking: 62, apiFootballId: 1569 },
  ...
  IRQ: { id: 'IRQ', name: 'Irak',            shortName: 'Irak',        code: 'IRQ', flag: '\u{1F1EE}\u{1F1F6}', confederation: 'AFC', eloRating: 1530, fifaRanking: 75, apiFootballId: 155 },
