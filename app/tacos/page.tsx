...
const salsas: Salsa[] = [
  {
    id: "nachos",
    name: "Nachos",
    description: "Totopos de maíz crujientes, perfectos para acompañar tus tacos"
  },
  {
    id: "chifles",
    name: "Chifles",
    description: "Plátano verde frito en rodajas crujientes, sabor tradicional peruano"
  },
  {
    id: "papas-fritas",
    name: "Papas fritas",
    description: "Papas doradas y crujientes, el acompañamiento clásico"
  },
];
    ...
    <div className="min-h-screen bg-black md:bg-transparent relative overflow-visible">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <svg className="absolute top-4 left-0 w-full h-16 opacity-35" viewBox="0 0 1200 60" preserveAspectRatio="none">
          ...
          {/* Banderines mexicanos (verde, blanco, rojo) */}
          <polygon points="40,8 20,40 60,40" fill="#059669" opacity="0.8"/>
          <polygon points="140,8 120,40 160,40" fill="#ffffff" opacity="0.6"/>
          <polygon points="240,8 220,40 260,40" fill="#dc2626" opacity="0.8"/>
          <polygon points="340,8 320,40 360,40" fill="#059669" opacity="0.8"/>
          <polygon points="440,8 420,40 460,40" fill="#ffffff" opacity="0.6"/>
          <polygon points="540,8 520,40 560,40" fill="#dc2626" opacity="0.8"/>
          <polygon points="640,8 620,40 660,40" fill="#059669" opacity="0.8"/>
          <polygon points="740,8 720,40 760,40" fill="#ffffff" opacity="0.6"/>
          <polygon points="840,8 820,40 860,40" fill="#dc2626" opacity="0.8"/>
          <polygon points="940,8 920,40 960,40" fill="#059669" opacity="0.8"/>
          <polygon points="1040,8 1020,40 1060,40" fill="#ffffff" opacity="0.6"/>
          <polygon points="1140,8 1120,40 1160,40" fill="#dc2626" opacity="0.8"/>
        </svg>

        {/* Globos mexicanos - Izquierda */}
        <div className="absolute top-20 left-8 opacity-40">
          <svg width="60" height="80" viewBox="0 0 60 80" className="animate-float">
            <ellipse cx="30" cy="35" rx="25" ry="30" fill="#059669" opacity="0.8"/>
        ...
        <div className="absolute top-32 left-16 opacity-40" style={{ animationDelay: '0.5s' }}>
          <svg width="50" height="70" viewBox="0 0 50 70" className="animate-float">
            <ellipse cx="25" cy="30" rx="20" ry="25" fill="#ffffff" opacity="0.7"/>
        ...
        <div className="absolute top-24 right-10 opacity-40" style={{ animationDelay: '0.3s' }}>
          <svg width="58" height="78" viewBox="0 0 58 78" className="animate-float">
            <ellipse cx="29" cy="34" rx="24" ry="29" fill="#dc2626" opacity="0.8"/>
        ...
        <div className="absolute top-40 right-20 opacity-40" style={{ animationDelay: '0.8s' }}>
          <svg width="52" height="72" viewBox="0 0 52 72" className="animate-float">
            <ellipse cx="26" cy="31" rx="21" ry="26" fill="#059669" opacity="0.8"/>
        ...
        <div className="absolute top-[60%] left-[5%] opacity-30 animate-float" style={{ animationDelay: '0.2s' }}>
          <svg width="40" height="40" viewBox="0 0 40 40">
            <rect x="5" y="10" width="30" height="25" rx="2" fill="#059669" opacity="0.8"/>
            <rect x="18" y="10" width="4" height="25" fill="#ffffff" opacity="0.9"/>
            <rect x="5" y="20" width="30" height="4" fill="#ffffff" opacity="0.9"/>
            <path d="M15 10 Q20 5, 25 10" stroke="#ffffff" strokeWidth="2" fill="none"/>
            <circle cx="20" cy="7" r="3" fill="#ffffff" opacity="0.8"/>
          </svg>
        </div>
        <div className="absolute top-[65%] right-[8%] opacity-30 animate-float" style={{ animationDelay: '0.7s' }}>
          <svg width="35" height="35" viewBox="0 0 35 35">
            <rect x="4" y="8" width="27" height="22" rx="2" fill="#dc2626" opacity="0.8"/>
            <rect x="16" y="8" width="3" height="22" fill="#ffffff" opacity="0.9"/>
            <rect x="4" y="17" width="27" height="3" fill="#ffffff" opacity="0.9"/>
            <path d="M13 8 Q17.5 4, 22 8" stroke="#ffffff" strokeWidth="2" fill="none"/>
            <circle cx="17.5" cy="6" r="2.5" fill="#ffffff" opacity="0.8"/>
          </svg>
        </div>
        <div className="absolute top-[70%] left-[15%] opacity-30 animate-float" style={{ animationDelay: '1.2s' }}>
          <svg width="38" height="38" viewBox="0 0 38 38">
            <rect x="4" y="9" width="30" height="24" rx="2" fill="#ffffff" opacity="0.7"/>
            <rect x="17" y="9" width="4" height="24" fill="#059669" opacity="0.9"/>
            <rect x="4" y="19" width="30" height="4" fill="#059669" opacity="0.9"/>
            <path d="M14 9 Q19 4, 24 9" stroke="#059669" strokeWidth="2" fill="none"/>
            <circle cx="19" cy="6" r="3" fill="#059669" opacity="0.8"/>
          </svg>
        </div>

        {/* Serpentinas mexicanas */}
        <div className="absolute top-0 left-[20%] w-2 h-40 bg-gradient-to-b from-emerald-600/30 to-transparent rotate-12"></div>
        <div className="absolute top-0 right-[25%] w-2 h-48 bg-gradient-to-b from-white/30 to-transparent -rotate-12"></div>
        <div className="absolute top-0 left-[45%] w-2 h-44 bg-gradient-to-b from-red-600/30 to-transparent rotate-8"></div>
        <div className="absolute top-0 right-[50%] w-2 h-52 bg-gradient-to-b from-emerald-600/30 to-transparent -rotate-8"></div>

        {/* Confetti mexicano */}
        <div className="absolute top-10 left-[30%] w-3 h-3 bg-emerald-600/40 rounded-full"></div>
        <div className="absolute top-16 right-[35%] w-2 h-2 bg-white/40 rounded-full"></div>
        <div className="absolute top-12 left-[60%] w-2 h-2 bg-red-600/40 rounded-full"></div>
        <div className="absolute top-20 right-[15%] w-3 h-3 bg-emerald-600/40 rounded-full"></div>
        <div className="absolute top-24 left-[70%] w-2 h-2 bg-red-600/40 rounded-full"></div>
      </div>
      ...
      {/* Header */}
      <header className="bg-gray-900 md:bg-transparent border-b-2 md:border-b-0 border-emerald-600 neon-border-taco sticky top-0 z-30 overflow-visible">
        <div className="container mx-auto px-3 md:px-4 py-2 md:py-1.5 flex justify-between items-center overflow-visible">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <Link
              href="/fit"
              className="text-xs md:text-sm font-bold text-cyan-400 hover:text-cyan-300 transition-colors neon-glow-fit px-2 md:px-3 py-1 md:py-1.5 rounded border border-cyan-500/30 hover:border-cyan-400"
            >
              Ver menú Ensaladas →
            </Link>
            <Link
              href="/fat"
              className="text-xs md:text-sm font-bold text-red-400 hover:text-red-300 transition-colors neon-glow-fat px-2 md:px-3 py-1 md:py-1.5 rounded border border-red-500/30 hover:border-red-400"
            >
              Ver menú Alitas →
            </Link>
          </div>
      ...
      <section className={`container mx-auto px-2 md:px-4 py-3 md:py-8 transition-all duration-300 overflow-visible ${completedOrders.length > 0 ? 'pb-20 md:pb-16' : 'pb-3 md:pb-3'}`}>
        ...
        <div className="relative flex items-center justify-center overflow-visible" style={{ overflow: 'visible' }}>
          ...
          <div
            ...
            className={`grid grid-cols-2 md:grid md:grid-cols-3 items-center md:items-stretch gap-x-3 gap-y-12 md:gap-6 lg:gap-8 w-full px-3 md:px-4 pt-10 pb-8 md:py-8 lg:py-10 select-none md:cursor-default md:overflow-visible`}
            ...
            {products.map((product, index) => {
              ...
              return (
                <div
                  ...
                  className={`${isLastOdd ? 'col-span-2 md:col-span-1 justify-self-center md:justify-self-auto' : ''} bg-gray-900 flex-shrink-0 md:flex-shrink neon-border-taco shadow-xl shadow-emerald-600/30 border-2 md:border-0 border-emerald-500 ${isSoldOut ? 'opacity-70 cursor-not-allowed' : ''}
                    ${isExpanded
                ...
                >
                  ...
                  <div className={`relative flex items-center justify-center overflow-visible ${
                    product.image.startsWith('/')
                      ...
                      : 'bg-gradient-to-br from-emerald-900/40 to-green-900/40 h-20 md:h-28 overflow-hidden rounded-t-lg md:rounded-t-xl border-b-2 border-emerald-600/30'
                    ...
                    <div className="flex items-center justify-between mb-1.5 md:mb-2.5">
                      ...
                      <div className="flex items-center gap-0.5 md:gap-1">
                        <button
                          ...
                          disabled={isSoldOut}
                          className={`w-5 h-5 md:w-7 md:h-7 text-white rounded text-xs md:text-sm font-bold transition-all flex items-center justify-center ${isSoldOut ? 'bg-gray-700 cursor-not-allowed opacity-40' : 'bg-emerald-700 hover:bg-emerald-600'}`}
                        >
                          −
                        </button>
                  ...
                  >
                    <div className="px-2.5 md:px-5 pb-2.5 md:pb-5 border-t-2 border-emerald-600/30 pt-2.5 md:pt-4">
                      {/* Selector de Acompañamientos - Acordeón */}
                      <div className="mb-2 md:mb-4">
                        ...
                        >
                          <div className="flex items-center gap-1.5 md:gap-2.5">
                            <span className="text-xs md:text-base">{canAdd ? '✓' : '🌮'}</span>
                            <span className={`text-[10px] md:text-sm font-bold ${canAdd ? 'text-green-400' : 'text-white'}`}>
                              {canAdd
                                ? `Acompañamientos seleccionados (${requiredSalsas})`
                                : `Acompaña tus tacos con:`
                              }
                            </span>
                          </div>
                          <div className="flex items-center gap-2 md:gap-3">
                      ...
                      <div className="mb-3 md:mb-4">
                        ...
                        <div className="mb-2 md:mb-3">
                          <button
                            ...
                            className="w-full flex items-center justify-between bg-emerald-600/20 hover:bg-emerald-600/30 border border-emerald-500/30 rounded-lg p-2 md:p-3 transition-all"
                          >
                            <div className="flex items-center gap-2 md:gap-2.5">
                              <span className="text-sm md:text-base">🥤</span>
                              <span className="text-white text-xs md:text-sm font-bold">Bebidas</span>
                            </div>
                            <span className="text-emerald-400 text-xs md:text-sm">{showBebidas[product.id] ? '▼' : '▶'}</span>
                          </button>
                            ...
                            <div className="mt-2 md:mt-3 space-y-1 md:space-y-2">
                              {[
                                ...
                                return (
                                  <div
                                    key={bebida.id}
                                    className="flex items-center justify-between bg-gray-800/30 rounded p-1.5 md:p-2 border border-emerald-500/10"
                                  >
                        ...
                        <div>
                          ...
                          >
                            ...
                            <span className="text-emerald-400 text-xs md:text-sm">{showExtras[product.id] ? '▼' : '▶'}</span>
                          </button>
                        ...
                        className={`w-full py-2.5 md:py-3.5 rounded-lg md:rounded-xl font-bold text-sm md:text-base transition-all
                          ${isSoldOut
                            ...
                            : (orderQuantity[product.id] || 0) === 0
                              ? 'bg-gray-700 text-gray-500 cursor-not-allowed border-2 border-gray-600'
                              : canAdd
                                ? 'bg-emerald-600 hover:bg-emerald-500 text-white neon-border-taco cursor-pointer active:scale-95'
                                : 'bg-gray-700 text-gray-500 cursor-not-allowed border-2 border-gray-600'
                          }
                        `}
                      >
                        {isSoldOut ? 'No disponible' : (orderQuantity[product.id] || 0) === 0 ? 'Agrega al menos 1 unidad' : canAdd ? (isEditingOrder ? 'Confirmar orden' : 'Agregar orden') : `Selecciona ${requiredSalsas} acompañamiento${requiredSalsas > 1 ? 's' : ''}`}
                      </button>
                    </div>
                  </div>
                </div>
                  ...
                  >
                    <div className="flex items-start justify-between mb-1 md:mb-2">
                      <div className="flex items-start gap-2 md:gap-3 flex-1">
                        <div className="w-10 h-10 md:w-16 md:h-16 rounded-lg overflow-hidden flex-shrink-0 bg-black border border-emerald-500/30 flex items-center justify-center">
                          {product.image.startsWith('/') ? (
                            <img
                              src={product.image}
                              alt={product.name}
      ...
      {/* Cart Summary Bar */}
      {completedOrders.length > 0 && (
        <div className="fixed bottom-0 left-0 right-0 bg-gray-900/95 backdrop-blur-sm border-t-4 border-emerald-600/50 shadow-2xl shadow-emerald-600/30 z-50">
            ...
            <div className="flex justify-between items-center gap-3 md:gap-5">
              ...
              {isOpen ? (
                <button
                  ...
                  className="bg-emerald-600 hover:bg-emerald-500 active:scale-95 text-white px-5 md:px-9 py-2.5 md:py-4 rounded-lg md:rounded-xl font-black text-sm md:text-xl transition-all neon-border-taco"
                >
      ...
      {showCartModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
          <div className="bg-gray-900 rounded-xl border-2 border-emerald-600 neon-border-taco max-w-md w-full max-h-[85vh] overflow-hidden flex flex-col">
            {/* Modal Header */}
            <div className="p-3 border-b-2 border-emerald-600/30 flex justify-between items-center">
              <h3 className="text-lg font-black text-emerald-400 neon-glow-taco">
                Tu Pedido
              </h3>
              <button
                onClick={() => setShowCartModal(false)}
                className="text-emerald-400 hover:text-emerald-300 text-2xl font-bold transition-all"
              >
                ×
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-3">
              <div className="space-y-2">
                {cart.map((item) => (
                  <div
                    key={item.product.id}
                    className="flex items-center gap-2 bg-gray-800/50 rounded-lg p-2 border border-emerald-500/20"
                  >
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="w-6 h-6 bg-emerald-700 hover:bg-emerald-600 text-white rounded text-xs font-bold transition-all flex items-center justify-center"
                      >
                        −
                      </button>
            ...
            {/* Modal Footer */}
            <div className="p-3 border-t-2 border-emerald-600/30 bg-gray-800/50">
              ...
              <Link
                href="/checkout"
                className="w-full bg-emerald-600 hover:bg-emerald-500 text-white px-6 py-3 rounded-lg font-black text-base transition-all neon-border-taco block text-center"
              >
                Continuar Pedido →
              </Link>
            </div>
