...
function ensureDataDirectory() {
  ...
  if (!fs.existsSync(productsFilePath)) {
    ...
    const initialProducts = [
      ...
      { id: "pequeno-dilema", name: "Pequeño Dilema", category: "fat", price: 28.90, cost: 14.00, active: true, stock: 60, minStock: 15, maxStock: 120 },
      { id: "duo-dilema", name: "Dúo Dilema", category: "fat", price: 39.90, cost: 20.00, active: true, stock: 50, minStock: 15, maxStock: 120 },
      { id: "todos-pecan", name: "Todos Pecan", category: "fat", price: 49.90, cost: 25.00, active: true, stock: 40, minStock: 10, maxStock: 100 },
